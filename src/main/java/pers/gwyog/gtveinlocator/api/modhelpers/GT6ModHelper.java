...
import gregapi.worldgen.GT6WorldGenerator.WorldGenContainer;
        ...
        if (ModConfig.veinLocatorEnabled) {
            ...
            if (!ModConfig.recipeVeinLocatorDisabled) {
                UT.Crafting.shaped(new ItemStack(ModItems.itemVeinLocator), UT.Crafting.Bits.DEFAULT, new Object[]{
                    ...
                    Character.valueOf('W'), OP.cableGt01.dat(MT.TinAlloy),
        ...
        if (ClientVeinNameHelper.basicSupport) {
            ...
            for (WorldgenOresLarge worldGen : WorldgenOresLarge.sList) {
                if (worldGen.mEnabled) {
                    GTVeinNameHelper.registerVeinName("gtveinlocator." + worldGen.mName);
                }
            }
        }
    }
        ...
        if (GTOreLayerHelper.basicSupport) {
            ...
            for (WorldgenOresLarge worldGen : WorldgenOresLarge.sList) {
                if (worldGen.mEnabled) {
                    ...
                    if (worldGen.mDimEnabled.containsKey(0)) {
                        GTOreLayerHelper.mapGTOverworldOreLayer.put(componentList, "gtveinlocator." + worldGen.mName);
                    ...
                    if (worldGen.mDimEnabled.containsKey(-1)) {
                        GTOreLayerHelper.mapGTNetherOreLayer.put(componentList, "gtveinlocator." + worldGen.mName);
                    ...
                    if (worldGen.mDimEnabled.containsKey(1)) {
                        GTOreLayerHelper.mapGTEndOreLayer.put(componentList, "gtveinlocator." + worldGen.mName);
